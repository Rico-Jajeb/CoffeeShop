                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5">
                                                    ...
                                                    <form action="{{ route('add_to_cart') }}" method="POST">
                                                        ...
                                                        <label for="quantity-input" class="mt-2 block mb-2 text-base font-medium text-gray-900 dark:text-white">Price: ₱ {{$image->product_price}} </label>
                                                        
                                                        <label for="quantity-input" class="mt-2 block mb-2 text-sm font-medium text-gray-900 dark:text-white">Choose quantity:</label>
...
<div class="bg-white">
    <a href="{{ route('shopping_cart_page') }}">Go to Shopping Cart</a>

</div>

<livewire:pages.cart.shopping-cart />
