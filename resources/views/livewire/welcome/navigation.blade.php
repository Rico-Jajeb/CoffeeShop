<div class="sm:fixed sm:top-0 sm:right-0 p-6 text-end z-10">
    ...
    <div class="flex items-center">
        <a href="{{ route('shopping_cart_page') }}" class="font-semibold text-gray-600 hover:text-gray-100 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"  >
