                        ...
                        <tbody>
                            ...
                            @foreach ($products as $image) 
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <button data-modal-target="crud-modal{{$image->id}}" data-modal-toggle="crud-modal{{$image->id}}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                                add Products {{$image->id}}
                                            </button>  
                                        </td>
                                    </tr>
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4">
                                                    <form class="p-4 md:p-5" action="{{ route('image.update') }}" method="POST" enctype="multipart/form-data" >
                                                        @csrf
                                                        <input type="text" name="product_id" value="{{$image->id}}" id="">
